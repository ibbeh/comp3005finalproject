...
# SQL to insert unique countries
insert_sql = """
...
seen_countries = {}  # To track unique countries
    ...
    if os.path.exists(filepath):
        with open(filepath, 'r', encoding='utf-8') as file:
            ...
            for match in matches:
                # Extracting manager's country info from both home and away teams
                        ...
                        for manager in team['managers']:
                            if 'country' in manager:
                                ...
                                if country_id and country_id not in seen_countries:
                                    # Insert unique country into the database
