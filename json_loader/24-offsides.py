                    ...
                    with open(event_file_path, 'r', encoding='utf-8') as event_file:
                        ...
                        for event in events:
                            if event.get('type', {}).get('name') == 'Pass':
                                pass_outcome = event['pass'].get('outcome', {}).get('name')
...
print("Offside events data successfully processed and inserted into the database.")
