...
insert_sql = """
INSERT INTO Ball_Recovery (event_id)
            ...
            for match in matches:
                ...
                if os.path.exists(event_file_path):
                    with open(event_file_path, 'r', encoding='utf-8') as event_file:
                        ...
                        for event in events:
                            if event.get('type', {}).get('name') == 'Ball Recovery':
                                event_id = event['id']
...
print("Ball recovery events data successfully processed and inserted into the database.")
